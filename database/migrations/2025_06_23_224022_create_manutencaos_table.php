...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('fornecedores', function (Blueprint $table) {
            ...
            $table->enum('for_tipo', ['mecanica', 'combustiveis', 'operacionais', 'gestao', 'outro'])->default('outro')->comment('Tipo do fornecedor: Oficina, Posto de Combustível, Ambos, ou Outro.');
