@if(Auth::user()->hasPermission('Veículos', 'visualizar') || Auth::user()->hasPermission('Veículos', 'criar'))
<div x-data="{ open: false }" class="menu-item-group">
    <button @click="open = !open" class="sidebar-link w-full flex justify-between items-center">
        <div class="flex items-center">
            ...
            <span class="menu-item-text">Veículos</span>
        </div>
    ...
    <div x-show="open" x-transition class="pl-8 space-y-1 mt-1 submenu-container">
        @if(Auth::user()->hasPermission('Veículos', 'visualizar'))
        <a href="{{ route('veiculos.index') }}" class="sidebar-submenu-link @if(request()->routeIs('veiculos.index')) active @endif">
            ...
            <span class="submenu-item-text">Listar Veículos</span>
        </a>
        @endif
        
        @if(Auth::user()->hasPermission('Veículos', 'criar'))
        <a href="{{ route('veiculos.create') }}" class="sidebar-submenu-link @if(request()->routeIs('veiculos.create')) active @endif">
            ...
            <span class="submenu-item-text">Novo Veículo</span>
        </a>
        @endif
        
        {{-- Links adicionais mantidos apenas se houver permissão de visualizar, ou conforme regra futura --}}
        @if(Auth::user()->hasPermission('Veículos', 'visualizar'))
        <a href="#" class="sidebar-submenu-link disabled">
            ...
            <span class="submenu-item-text">* Pendências</span>
        </a>
        <a href="#" class="sidebar-submenu-link disabled">
            ...
            <span class="submenu-item-text">* Relatórios</span>
        </a>
        @endif
    </div>
</div>
