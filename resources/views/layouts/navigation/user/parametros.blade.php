<div class="menu-item-group">
    ...
    <div x-show="open === 'configuracoes'" x-transition class="pl-8 space-y-1 mt-1 submenu-container">
        <a href="{{ route('logs.index') }}" class="sidebar-submenu-link @if(request()->routeIs('logs.index')) active @endif">
            ...
            <span class="submenu-item-text">Logs de Atividade</span>
        </a>
        <a href="{{ route('parametros.index') }}" class="sidebar-submenu-link @if(request()->routeIs('parametros.*')) active @endif">
            <span class="mr-3">
