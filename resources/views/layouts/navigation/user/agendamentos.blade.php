<!-- Bloco de Navegação: Agendamentos -->
<div x-data="{ open: (open === 'agendamentos' ? '' : 'agendamentos') }" class="space-y-1">
    <button @click="open = ! open"
        ...
        <svg :class="{'rotate-180': open === 'agendamentos'}" class="h-5 w-5 transform transition-transform" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
        </svg>
    </button>
    <div x-show="open === 'agendamentos'" x-transition class="pl-8 space-y-1 mt-1">
        ...
        <a href="{{ route('reservas.create') }}" class="sidebar-submenu-link @if(request()->routeIs('reservas.create')) active @endif">
         ...
         <!-- Futuros links: Calendário, Minhas Reservas, etc. -->
    </div>
</div>
