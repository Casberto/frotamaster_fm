...
{{-- 
    Adicione estas classes ao seu arquivo CSS principal (ex: resources/css/app.css) 
    para garantir que a aparência corresponda ao esperado.
--}}
<style>
