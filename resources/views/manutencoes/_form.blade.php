    ...
    <div class="form-section">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
                ...
                <input type="number" name="quilometragem" id="quilometragem" class="mt-1 block w-full" value="{{ old('quilometragem', $manutencao->quilometragem ?? '') }}" required>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="number" name="proxima_revisao_km" id="proxima_revisao_km" class="mt-1 block w-full" value="{{ old('proxima_revisao_km', $manutencao->proxima_revisao_km ?? '') }}">
            </div>
            <div>
