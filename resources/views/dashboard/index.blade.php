<x-app-layout>
    ...
    @else
        ...
        <div class="hidden lg:block">
            <div class="space-y-8" x-data="{ tab: new URLSearchParams(window.location.search).get('tab') || 'geral', openVeiculo: null }">
                ...
                <div class="border-b border-gray-200">
                    <nav class="-mb-px grid grid-cols-2 md:grid-cols-3 lg:flex lg:space-x-6 gap-2 p-2 lg:p-0" aria-label="Tabs">
                        {{-- Aba Geral --}}
                        <button
                            @click.prevent="tab = 'geral'"
                            :class="{
                                'border-blue-500 text-blue-600 bg-blue-50 lg:bg-transparent': tab === 'geral',
                                'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 hover:bg-gray-50 lg:hover:bg-transparent': tab !== 'geral'
                            }"
                            class="w-full min-w-0 relative whitespace-nowrap py-3 px-4 lg:px-1 border rounded-lg lg:rounded-none lg:border-0 lg:border-b-2 font-medium text-sm focus:outline-none flex items-center justify-center lg:justify-start group transition-colors duration-200"
                            aria-current="page"
                        >
                        ...
                        <button
                            ...
                            :class="{
                                'border-blue-500 text-blue-600 bg-blue-50 lg:bg-transparent': tab === 'veiculos',
                                'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 hover:bg-gray-50 lg:hover:bg-transparent': tab !== 'veiculos'
                            }"
                            class="w-full min-w-0 relative whitespace-nowrap py-3 px-4 lg:px-1 border rounded-lg lg:rounded-none lg:border-0 lg:border-b-2 font-medium text-sm focus:outline-none flex items-center justify-center lg:justify-start group transition-colors duration-200"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" 
                                viewBox="0 0 256 256" 
                                class="w-5 h-5 mr-2 fill-current flex-shrink-0">
                        ...
                        <button
                            ...
                            :class="{
                                'border-blue-500 text-blue-600 bg-blue-50 lg:bg-transparent': tab === 'motoristas',
                                'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 hover:bg-gray-50 lg:hover:bg-transparent': tab !== 'motoristas'
                            }"
                            class="w-full min-w-0 relative whitespace-nowrap py-3 px-4 lg:px-1 border rounded-lg lg:rounded-none lg:border-0 lg:border-b-2 font-medium text-sm focus:outline-none flex items-center justify-center lg:justify-start group transition-colors duration-200"
                        >
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            ...
                            <span class="truncate">Motoristas</span>
                        ...
                        <button
                            ...
                            :class="{
                                'border-blue-500 text-blue-600 bg-blue-50 lg:bg-transparent': tab === 'manutencoes',
                                'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 hover:bg-gray-50 lg:hover:bg-transparent': tab !== 'manutencoes'
                            }"
                            class="w-full min-w-0 relative whitespace-nowrap py-3 px-4 lg:px-1 border rounded-lg lg:rounded-none lg:border-0 lg:border-b-2 font-medium text-sm focus:outline-none flex items-center justify-center lg:justify-start group transition-colors duration-200"
                        >
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <button
                            ...
                            :class="{
                                'border-blue-500 text-blue-600 bg-blue-50 lg:bg-transparent': tab === 'abastecimentos',
                                'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 hover:bg-gray-50 lg:hover:bg-transparent': tab !== 'abastecimentos'
                            }"
                            class="w-full min-w-0 relative whitespace-nowrap py-3 px-4 lg:px-1 border rounded-lg lg:rounded-none lg:border-0 lg:border-b-2 font-medium text-sm focus:outline-none flex items-center justify-center lg:justify-start group transition-colors duration-200"
                        >
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <button
                            ...
                            :class="{
                                'border-blue-500 text-blue-600 bg-blue-50 lg:bg-transparent': tab === 'reservas',
                                'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 hover:bg-gray-50 lg:hover:bg-transparent': tab !== 'reservas'
                            }"
                            class="w-full min-w-0 relative whitespace-nowrap py-3 px-4 lg:px-1 border rounded-lg lg:rounded-none lg:border-0 lg:border-b-2 font-medium text-sm focus:outline-none flex items-center justify-center lg:justify-start group transition-colors duration-200"
                        >
                            <svg class="w-5 h-5 mr-2 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div class="block lg:hidden">
            @include('dashboard.mobile.index')
        </div>
    @endif
</x-app-layout>
