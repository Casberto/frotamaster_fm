...
<div class="space-y-8">
        ...
        <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="mot_nome" id="mot_nome" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_nome', $motorista->mot_nome) }}" required>
                </div>

                {{-- mot_status (Obrigatório sempre) --}}
                <div>
                    <label for="mot_status" class="block font-medium text-sm text-gray-700">Status*</label>
                    <select name="mot_status" id="mot_status" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                ...
                <div>
                    ...
                    <select name="mot_user_id" id="mot_user_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="text" name="mot_apelido" id="mot_apelido" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_apelido', $motorista->mot_apelido) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="date" name="mot_data_nascimento" id="mot_data_nascimento" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_data_nascimento', optional($motorista->mot_data_nascimento)->format('Y-m-d')) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <select name="mot_genero" id="mot_genero" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="text" name="mot_nacionalidade" id="mot_nacionalidade" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_nacionalidade', $motorista->mot_nacionalidade) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <select name="mot_estado_civil" id="mot_estado_civil" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="mot_nome_mae" id="mot_nome_mae" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_nome_mae', $motorista->mot_nome_mae) }}">
                </div>
                @endif
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="mot_nome_pai" id="mot_nome_pai" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_nome_pai', $motorista->mot_nome_pai) }}">
                </div>
                @endif
                ...
                @if($configuracoes['usar_email'] ?? false)
                 <div>
                    ...
                    <input type="email" name="mot_email" id="mot_email" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_email', $motorista->mot_email) }}">
                </div>
                @endif
                ...
                @if($configuracoes['usar_telefone1'] ?? false)
                 <div>
                    ...
                    <input type="text" name="mot_telefone1" id="mot_telefone1" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_telefone1', $motorista->mot_telefone1) }}">
                </div>
                @endif
                ...
                @if($configuracoes['usar_telefone2'] ?? false)
                 <div>
                    ...
                    <input type="text" name="mot_telefone2" id="mot_telefone2" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_telefone2', $motorista->mot_telefone2) }}">
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="mot_cep" id="mot_cep" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_cep', $motorista->mot_cep) }}">
                </div>
                @endif
                ...
                <div class="md:col-span-3">
                    ...
                    <input type="text" name="mot_endereco" id="mot_endereco" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_endereco', $motorista->mot_endereco) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_numero" id="mot_numero" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_numero', $motorista->mot_numero) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_complemento" id="mot_complemento" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_complemento', $motorista->mot_complemento) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_bairro" id="mot_bairro" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_bairro', $motorista->mot_bairro) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_cidade" id="mot_cidade" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_cidade', $motorista->mot_cidade) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_estado" id="mot_estado" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_estado', $motorista->mot_estado) }}">
                </div>
                @endif
            </div>
        </div>
    ...
    {{-- TAB 2: DOCUMENTAÇÃO --}}
    @if($showTabDocs)
    <div id="tab-docs-content" x-show="tab === 'docs' || mobile" class="space-y-6 animate-fade-in-up mobile-stacked-force" style="display: none;">
        
        @php
            $showSectionDocsPessoais = false;
            $personalDocsFields = ['usar_cpf', 'usar_rg', 'usar_orgao_emissor_rg', 'usar_data_emissao_rg', 'usar_pis', 'usar_ctps_numero', 'usar_ctps_serie', 'usar_titulo_eleitor', 'usar_zona_eleitoral', 'usar_secao_eleitoral'];
            foreach ($personalDocsFields as $field) {
                if ($configuracoes[$field] ?? false) {
                    $showSectionDocsPessoais = true;
                    break;
                }
            }
        @endphp

        @if($showSectionDocsPessoais)
        {{-- Seção de Documentos --}}
        <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-100">
            <h3 class="text-lg font-semibold text-gray-800 border-b pb-3 mb-4 sm:mb-6 flex items-center gap-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="mot_cpf" id="mot_cpf" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_cpf', $motorista->mot_cpf) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_rg" id="mot_rg" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_rg', $motorista->mot_rg) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_orgao_emissor_rg" id="mot_orgao_emissor_rg" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_orgao_emissor_rg', $motorista->mot_orgao_emissor_rg) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="date" name="mot_data_emissao_rg" id="mot_data_emissao_rg" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_data_emissao_rg', optional($motorista->mot_data_emissao_rg)->format('Y-m-d')) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_pis" id="mot_pis" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_pis', $motorista->mot_pis) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_ctps_numero" id="mot_ctps_numero" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_ctps_numero', $motorista->mot_ctps_numero) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_ctps_serie" id="mot_ctps_serie" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_ctps_serie', $motorista->mot_ctps_serie) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_titulo_eleitor" id="mot_titulo_eleitor" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_titulo_eleitor', $motorista->mot_titulo_eleitor) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_zona_eleitoral" id="mot_zona_eleitoral" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_zona_eleitoral', $motorista->mot_zona_eleitoral) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_secao_eleitoral" id="mot_secao_eleitoral" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_secao_eleitoral', $motorista->mot_secao_eleitoral) }}">
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="mot_cnh_numero" id="mot_cnh_numero" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_cnh_numero', $motorista->mot_cnh_numero) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <select name="mot_cnh_categoria" id="mot_cnh_categoria" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="date" name="mot_cnh_data_emissao" id="mot_cnh_data_emissao" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_cnh_data_emissao', optional($motorista->mot_cnh_data_emissao)->format('Y-m-d')) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="date" name="mot_cnh_data_validade" id="mot_cnh_data_validade" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_cnh_data_validade', optional($motorista->mot_cnh_data_validade)->format('Y-m-d')) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="date" name="mot_cnh_primeira_habilitacao" id="mot_cnh_primeira_habilitacao" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_cnh_primeira_habilitacao', optional($motorista->mot_cnh_primeira_habilitacao)->format('Y-m-d')) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <select name="mot_cnh_uf" id="mot_cnh_uf" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                ...
                <div class="md:col-span-4">
                    ...
                    <textarea name="mot_cnh_observacoes" id="mot_cnh_observacoes" rows="2" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">{{ old('mot_cnh_observacoes', $motorista->mot_cnh_observacoes) }}</textarea>
                </div>
                @endif
            </div>
        </div>
    ...
    {{-- TAB 3: PROFISSIONAL E OUTROS --}}
    @if($showTabProfissional)
    <div id="tab-profissional-content" x-show="tab === 'profissional' || mobile" class="space-y-6 animate-fade-in-up mobile-stacked-force" style="display: none;">
        ...
        <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="mot_data_admissao" id="mot_data_admissao" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_data_admissao', optional($motorista->mot_data_admissao)->format('Y-m-d')) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="date" name="mot_data_demissao" id="mot_data_demissao" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_data_demissao', optional($motorista->mot_data_demissao)->format('Y-m-d')) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <select name="mot_tipo_contrato" id="mot_tipo_contrato" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        <option value="">Selecione...</option>
                ...
                <div>
                    ...
                    <input type="text" name="mot_categoria_profissional" id="mot_categoria_profissional" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_categoria_profissional', $motorista->mot_categoria_profissional) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_matricula_interna" id="mot_matricula_interna" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_matricula_interna', $motorista->mot_matricula_interna) }}">
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-100">
            <h3 class="text-lg font-semibold text-gray-800 border-b pb-3 mb-4 sm:mb-6 flex items-center gap-2">
                <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z"></path></svg>
                Dados Bancários
            </h3>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="mot_banco" id="mot_banco" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_banco', $motorista->mot_banco) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_agencia" id="mot_agencia" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_agencia', $motorista->mot_agencia) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <input type="text" name="mot_conta" id="mot_conta" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_conta', $motorista->mot_conta) }}">
                </div>
                @endif
                ...
                <div>
                    ...
                    <select name="mot_tipo_conta" id="mot_tipo_conta" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="text" name="mot_chave_pix" id="mot_chave_pix" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" value="{{ old('mot_chave_pix', $motorista->mot_chave_pix) }}">
                </div>
                @endif
            </div>
        </div>
        ...
        <div class="bg-white p-4 sm:p-6 rounded-lg shadow-sm border border-gray-100">
            ...
            <div>
                ...
                <textarea name="mot_observacoes" id="mot_observacoes" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">{{ old('mot_observacoes', $motorista->mot_observacoes) }}</textarea>
            </div>
        </div>
        @endif
    </div>
...
<div class="flex items-center justify-end mt-8 mb-4">
    <a href="{{ route('motoristas.index') }}" class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition shadow-sm font-medium">Cancelar</a>
    <button type="submit" class="ml-4 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition shadow-sm font-medium">Salvar Motorista</button>
</div>
